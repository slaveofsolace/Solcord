...
} from "../../src/betterdiscord/modules/soulcord/double-click-reply";
...
describe("double-click reply domain policy", () => {
    ...
    test("ignores links, buttons, forms, code blocks, editable controls, and SoulCord-owned UI", () => {
        const blocked = [
            {tagName: "a"},
            {tagName: "BUTTON"},
            {tagName: "form"},
            ...
            {tagName: "div", soulcordOwned: true}
        ];
