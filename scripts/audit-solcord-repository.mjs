...
This inventory is a text scan, not a semantic review or live Discord test. Current release state and desktop acceptance limits are recorded in [Release status](../STATUS.md). Version-specific records remain in the [archive](../archive/README.md).
...
- Added a repeatable audit command and preserved engineering handoffs.
