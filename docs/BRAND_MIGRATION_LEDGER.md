...
| Theme family | Added SoulCord Default, four accepted V1 alternatives, and six structurally distinct V2 full-shell themes with one-active-theme transaction behavior and no remote assets. |
