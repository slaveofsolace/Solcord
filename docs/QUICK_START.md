...
This guide applies to `v2.0.0-rc.33` on the official Solcord release page. The steps are written for someone who has never installed a Discord client mod.
