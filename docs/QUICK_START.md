...
This guide uses the verified `v2.0.0-rc.4` release. It is designed for someone who has never installed a Discord client mod.

> [!WARNING]
> Solcord RC4 is not code-signed. Windows may call it an unknown publisher. Download only from `slaveofsolace/Solcord` and compare its SHA-256 value with the release manifest before opening it.

## 1. Download

Download both files into the same folder:

- [SolcordSetup-v2.0.0-rc.4-win-x64.exe](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/SolcordSetup-v2.0.0-rc.4-win-x64.exe)
- [SHA256SUMS.txt](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/SHA256SUMS.txt)

![Download Solcord and its checksum list](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/01-download.png)

Optional verification in PowerShell:

```powershell
Get-FileHash .\SolcordSetup-v2.0.0-rc.4-win-x64.exe -Algorithm SHA256
```
...
![Quit Discord before installation](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/02-quit-discord.png)
...
![Install the verified Solcord artifact](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/03-install.png)
...
![Verify the installed artifact before launch](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/04-verified.png)
...
![Solcord First Setup](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/05-first-setup.png)
...
![Solcord recovery and Plugin Doctor](https://github.com/slaveofsolace/Solcord/releases/download/v2.0.0-rc.4/06-recovery.png)
