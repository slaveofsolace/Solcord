...
The warm-black, paper, and coral direction was refined after inspecting the owner-controlled public [SOL site](https://slaveofsolace.com/). The reference established warm near-black, paper-white type, coral signals, oxidized teal, thin rules, and restrained motion. On 2026-08-30 the owner explicitly selected the homepage's paired-strand canvas as Motion Studio's shell-wide **SOL flow**. Solcord adapts that owner-controlled algorithm from pinned portfolio commit `91fdd4a1bf747a5cb8b4b66694741c2492c4be7e`: it uses fewer frames, bounded density, complete teardown, no remote asset, and Discord-aware light/dark compositing. No portfolio logo, image, private content, analytics, or network behavior is copied.
