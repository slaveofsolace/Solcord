...
| ---: | --- | ---: | ---: |
| 1 | `src/betterdiscord/modules/solcord/runtime.ts` | 2,992 | 182.7 KiB |
| 2 | `scripts/prepare-solcord-disposable-acceptance.ts` | 1,428 | 65.3 KiB |
| 3 | `bun.lock` | 1,314 | 143.0 KiB |
| 4 | `tests/solcord/storage-security.test.ts` | 1,231 | 70.3 KiB |
...
| 12 | `src/betterdiscord/styles/solcord.css` | 789 | 58.4 KiB |
...
| 2 | `tests/solcord/storage-security.test.ts` | 1,231 | 70.3 KiB |
...
| 6 | `src/electron/main/modules/solcord-timeline.ts` | 824 | 36.9 KiB |
| 7 | `src/betterdiscord/styles/solcord.css` | 789 | 58.4 KiB |
