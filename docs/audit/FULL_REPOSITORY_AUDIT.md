...
| 16 | `scripts/build-solcord-runtime-catalog.cjs` | 281 | 16.6 KiB |
| 17 | `docs/evidence/catalog/local-addon-inventory.json` | 279 | 10.4 KiB |
| 18 | `tests/solcord/runtime-acceptance-generator.test.ts` | 268 | 12.4 KiB |
| 19 | `src/electron/main/modules/solcord-audience-guard.ts` | 259 | 12.3 KiB |
| 20 | `tests/solcord/renderer-security.test.ts` | 255 | 18.1 KiB |
