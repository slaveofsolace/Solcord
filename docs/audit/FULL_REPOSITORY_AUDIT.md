...
| Text lines scanned | 108,515 |
| Custom Solcord lines | 22,893 |
...
| 7 | `src/betterdiscord/ui/solcord/panel.tsx` | 1,088 | 102.2 KiB |
...
| 11 | `src/betterdiscord/styles/solcord.css` | 886 | 67.0 KiB |
...
| 4 | `src/betterdiscord/ui/solcord/panel.tsx` | 1,088 | 102.2 KiB |
| 5 | `src/electron/main/modules/solcord-setup.ts` | 899 | 50.5 KiB |
| 6 | `src/betterdiscord/styles/solcord.css` | 886 | 67.0 KiB |
