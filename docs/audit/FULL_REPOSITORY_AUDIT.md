...
| Text lines scanned | 129,436 |
| Custom Solcord lines | 35,380 |
...
| Patch calls | 30 | 3 |
| Synchronous filesystem calls | 800 | 726 |
| Console calls | 81 | 55 |
...
| 11 | `CHANGELOG.md` | 1,142 | 40.4 KiB |
...
| 16 | `installer/Solcord.Installer/InstallerEngine.cs` | 802 | 53.9 KiB |
| 17 | `src/betterdiscord/modules/addonstore.ts` | 732 | 23.1 KiB |
| 18 | `installer/Solcord.Installer/InstallerForm.cs` | 699 | 39.3 KiB |
| 19 | `src/common/solcord/v2-feature-models.ts` | 661 | 36.1 KiB |
...
| 5 | `src/betterdiscord/styles/solcord.css` | 1,218 | 92.2 KiB |
...
| 10 | `src/common/solcord/v2-feature-models.ts` | 661 | 36.1 KiB |
