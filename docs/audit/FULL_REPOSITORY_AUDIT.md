...
| Measure | Count |
| --- | ---: |
| Persistent tracked files | 608 |
| Text files scanned | 593 |
| Binary files classified | 15 |
| Text lines scanned | 128,690 |
| Custom Solcord lines | 34,919 |
...
| Patch calls | 30 | 3 |
| Synchronous filesystem calls | 795 | 723 |
| Console calls | 79 | 53 |
...
| 11 | `CHANGELOG.md` | 1,133 | 39.4 KiB |
