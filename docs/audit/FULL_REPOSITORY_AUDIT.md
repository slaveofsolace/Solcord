...
| Text lines scanned | 107,820 |
| Custom Solcord lines | 22,234 |
...
| ---: | --- | ---: | ---: |
| 1 | `src/betterdiscord/modules/solcord/runtime.ts` | 3,045 | 186.1 KiB |
...
| 9 | `src/betterdiscord/ui/solcord/panel.tsx` | 1,011 | 96.1 KiB |
...
| 4 | `src/betterdiscord/ui/solcord/panel.tsx` | 1,011 | 96.1 KiB |
