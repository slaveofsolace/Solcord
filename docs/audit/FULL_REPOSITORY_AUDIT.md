...
| Text lines scanned | 108,922 |
| Custom Solcord lines | 23,046 |
...
| Patch calls | 25 | 1 |
| Synchronous filesystem calls | 613 | 548 |
| Console calls | 75 | 57 |
...
| ---: | --- | ---: | ---: |
| 1 | `src/betterdiscord/modules/solcord/runtime.ts` | 3,295 | 200.0 KiB |
...
| 9 | `src/betterdiscord/modules/solcord/store.ts` | 1,053 | 55.7 KiB |
...
| 3 | `src/betterdiscord/ui/solcord/panel.tsx` | 1,185 | 112.2 KiB |
| 4 | `tests/solcord/disposable-acceptance.test.ts` | 1,149 | 55.2 KiB |
| 5 | `src/betterdiscord/styles/solcord.css` | 956 | 73.4 KiB |
...
| 14 | `src/betterdiscord/ui/solcord/setup-wizard.tsx` | 391 | 35.7 KiB |
...
| 17 | `src/common/solcord/product.ts` | 288 | 14.3 KiB |
