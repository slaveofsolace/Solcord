...
| Text lines scanned | 129,265 |
| Custom Solcord lines | 35,357 |
...
| 11 | `CHANGELOG.md` | 1,139 | 39.9 KiB |
...
| 18 | `src/common/solcord/v2-feature-models.ts` | 661 | 36.1 KiB |
| 19 | `installer/Solcord.Installer/InstallerForm.cs` | 654 | 36.3 KiB |
