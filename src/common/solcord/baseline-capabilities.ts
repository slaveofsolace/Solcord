...
const CAPABILITIES: readonly SolcordBaselineCapability[] = [
    {
        ...
        inspiration: {name: "CollapsibleUI", url: "https://betterdiscord.app/plugin/CollapsibleUI"},
        performanceOrder: 1,
        defaultEnabled: false,
        loading: "lazy",
        disabledRuntimeCost: "none",
    ...
    },
    {
        ...
        inspiration: {name: "CollapseEmbeds", url: "https://betterdiscord.app/plugin/CollapseEmbeds"},
        performanceOrder: 2,
        defaultEnabled: false,
        loading: "lazy",
        disabledRuntimeCost: "none",
    ...
    },
    {
        ...
        inspiration: {name: "AutoScroll", url: "https://betterdiscord.app/plugin/AutoScroll"},
        performanceOrder: 3,
        defaultEnabled: false,
        loading: "lazy",
        disabledRuntimeCost: "none",
    ...
    },
    {
        ...
        inspiration: {name: "ImageFolder", url: "https://betterdiscord.app/plugin/ImageFolder"},
        performanceOrder: 4,
        defaultEnabled: false,
        loading: "lazy",
        disabledRuntimeCost: "none",
    ...
    },
    {
        ...
        inspiration: {name: "MessageLinkEmbed", url: "https://betterdiscord.app/plugin/MessageLinkEmbed"},
        performanceOrder: 5,
        defaultEnabled: false,
        loading: "lazy",
        disabledRuntimeCost: "none",
