...
export interface SoulCordAttachmentInspection {
    valid: boolean;
    host?: string;
    filename?: string;
    extension?: string;
...
export function inspectSoulCordAttachment(input: string, declaredMime?: string): SoulCordAttachmentInspection {
    let url: URL;
    ...
    let risk: SoulCordAttachmentInspection["risk"] = reasons.length ? "review" : "ordinary";
