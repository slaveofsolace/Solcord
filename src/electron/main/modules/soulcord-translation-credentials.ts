...
export class SoulCordTranslationCredentialStorage {
    ...
    #root(create: boolean): string | undefined {
        ...
        const root = path.join(betterDiscord, "soulcord-translation-credentials-v1");
...
export default new SoulCordTranslationCredentialStorage();
