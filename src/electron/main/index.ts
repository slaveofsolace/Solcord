...
if (!process.argv.includes("--vanilla")) {
    ...
    console.log(`Welcome to Solcord ${process.env.__CANDIDATE__} (core ${process.env.__VERSION__}, build ${process.env.__BUILD__}, source ${process.env.__COMMIT__?.slice(0, 7)})`);
