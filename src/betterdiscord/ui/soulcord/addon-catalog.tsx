...
export function CuratedAddonSet() {
    ...
    return <section className="soulcord-section">
        ...
        <p className="soulcord-callout">Integrity check: {state.integrity.summary.match} verified · {state.integrity.summary.missing} not staged · {state.integrity.summary.attention + state.integrity.summary.unavailable} held for review. Status names and hash prefixes are shown without local file paths.</p>
