...
import type {SoulCordDisposalScope} from "./disposal";


const PATCH_CALLER = "SoulCord~DoNotTrack";
 ...
 * SoulCord never enumerates a module looking for additional methods.
 */
