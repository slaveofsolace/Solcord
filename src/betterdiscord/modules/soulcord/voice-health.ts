...
import type {SoulCordVoiceHealthSample} from "@common/soulcord/v2-feature-models";
...
export function normalizeCachedVoiceHealthSample(value: unknown, timestamp = Date.now()): SoulCordVoiceHealthSample | undefined {
 ...
 */
export function createCachedVoiceHealthReader(candidates: readonly unknown[], clock: () => number = Date.now): (() => SoulCordVoiceHealthSample | undefined) | undefined {
